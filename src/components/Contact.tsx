          ...
          <div className="bg-card-dark rounded-xl p-8 border border-border shadow-xl">
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="flex items-center space-x-4 p-4 rounded-lg bg-card border border-border hover:border-primary/50 transition-all duration-300 hover:scale-105 group"
                >
